...
#include "TransformationMatrixLib.h"

FMatrix UTransformationMatrixLib::TransformationMatrix(FRotator InRot, FVector InTrans)
{
	/**
		T = [A00 A01 A02 Px
			 A10 A11 A12 Py
...
FMatrix UTransformationMatrixLib::TransformationMatrix_Inverse(FMatrix InTransformationMatrix)
{
	/**
...
FMatrix UTransformationMatrixLib::TransformationMatrix_Multiply(FMatrix InTransformationMatrix1, FMatrix InTransformationMatrix2)
{
	/**
		K = I*J;
		//ROW0
...
FVector UTransformationMatrixLib::TransformationMatrix_PositionExtract(FMatrix InTransformationMatrix)
{
...
FRotator UTransformationMatrixLib::TransformationMatrix_RotationRPYExtract(FMatrix InTransformationMatrix)
{
	/**
...
float UTransformationMatrixLib::AngleOffsetCorrector(float InAngle)
{
	if (InAngle > 180.0f)
	{
